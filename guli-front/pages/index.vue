      ...
      <div class="swiper-wrapper">
        ...
        >
          <a target="_blank" :href="banner.linkUrl">
            <img :src="banner.imageUrl" :alt="banner.tatle"/>
          </a>
        </div>
      </div>
          ...
          <div>
            <article class="comm-course-list">
              <ul class="of" id="bna">
                ...
                <li v-for="course in eduCourses" :key="course.id">
                  <div class="cc-l-wrap">
          ...
          <div>
            <article class="i-teacher-list">
              <ul class="of">
                ...
                <li v-for="teacher in eduTeachers" :key="teacher.id">
  ...
  methods: {
    ...
    getIndexData() {
      index.getIndexData().then((resp) => {
        this.eduCourses = resp.data.data.eduCourses;
        this.eduTeachers = resp.data.data.eduTeachers;
      });
    },
  },
};
